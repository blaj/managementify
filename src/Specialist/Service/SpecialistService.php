...
class SpecialistService {
  ...
  public function update(
    ...
    $this->specialistRepository->save(
        ($this->specialistFetchService->fetchSpecialist($id, $companyId))
  ...
  public function delete(int $id, int $companyId): void {
    $this->specialistRepository->softDeleteById(
        $this->specialistFetchService->fetchSpecialist($id, $companyId)->getId());
  }
}